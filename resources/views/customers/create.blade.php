                                            ...
                                            <div class="col-span-full">
                                                <div class="flex items-center lg:justify-end space-x-2">
                                                    <div class="flex space-x-4">
                                                        <button type="submit" class="px-5 py-3 bg-green-500 hover:bg-green-800 rounded-md disabled:opacity-75">Cadastrar</button>
    ...
    <script>
        document.addEventListener('alpine:init', () => {
            Alpine.data('app', () => ({
                ...
                async store() {
                    try {
                        const { data } = await axios.post('{{ route("api.customers.store") }}', this.form)
